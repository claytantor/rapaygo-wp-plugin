(function () {
    ...
    tinymce.create('tinymce.plugins.wpCartShortcode', {
        ...
        init: function (ed, url) {
            ed.addButton('rapaygo_cart_shortcode', {
                icon: 'wp-cart-tinymce',
                tooltip: 'WP Cart Shortcode',
                cmd: 'rapaygo_cart_shortcode'
            });

            ed.addCommand('rapaygo_cart_shortcode', function () {
                ...
                jQuery.post(
                        rapaygo_cart_admin_ajax_url,
                        {
                            action: 'rapaygo_cart_get_tinymce_form',
                            dataType: 'html',
                        },
                        function (response) {
    ...
    // Register plugin
    tinymce.PluginManager.add('rapaygo_cart_shortcode', tinymce.plugins.wpCartShortcode);
})();
